...
public class MiniMap extends BackgroundTiles {
	...
	public void drawMiniMap(Graphics2D g) {
		BufferedImage original = new BufferedImage(GamePanel.MAP_WIDTH, GamePanel.MAP_HEIGHT,
				BufferedImage.TYPE_INT_RGB); // full gameboard image
		...
		gR.drawImage(original, 0, 0, width, height, 0, 0, original.getWidth(), original.getHeight(), null); // draw
																											// resized
																											// image
		gR.dispose();
